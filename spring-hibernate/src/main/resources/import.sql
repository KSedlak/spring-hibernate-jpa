...
insert into LIBRARY (id, name, address_id, version, typeL) values (1, 'Biblioteka Rynek', 1, 1,'academic' );
insert into LIBRARY (id, name, address_id, version, typeL) values (2, 'Biblioteka Miejska', 2, 1, 'children');
