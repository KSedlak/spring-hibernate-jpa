...
insert into libraryType (id, typeL) values (1, 'X');
insert into Library (id, name, address_id,type_id) values (1, 'Biblioteka Rynek', 1,1);
insert into Library (id, name, address_id,type_id) values (2, 'Biblioteka Miejska', 2,1);
