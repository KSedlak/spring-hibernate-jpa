...
public interface LibraryRepository extends JpaRepository<LibraryEntity, Long>, LibraryAdditionalQueries {
    ...
    @Query("from LibraryEntity l where l.libraryType = :type")
    List<LibraryEntity> findByType_custom(@Param("type") LibraryType type);
    
    List<LibraryEntity> findByLibraryType(@Param("type") LibraryType type);//autoGenerated
    
    List<LibraryEntity> findByAddress_Street(@Param("street") String street);//autoGenerated
