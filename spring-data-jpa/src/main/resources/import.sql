...
insert into LIBRARY (id, name, address_id, version, library_type) values (1, 'Biblioteka Rynek', 1, 1,'academic' );
insert into LIBRARY (id, name, address_id, version, library_type) values (2, 'Biblioteka Miejska', 2, 1, 'children');
...
insert into PERSON (id, first_name, last_name, age) values (2, 'Jan', 'Nowak', 44);
